          ...
          {Object.entries(player.weeklyStats).map(([week, weekData], index) => {
            ...
            return (
              <tr key={index}>
                ...
                <td className={`border px-4 py-2 ${targetsColor} bg-opacity-50`}>{weekData.stats.rec_tgt || 0}</td>
                <td className={`border px-4 py-2 ${recColor} bg-opacity-50`}>{weekData.stats.rec}</td>
                <td className={`border px-4 py-2 ${tdColor} bg-opacity-50`}>{weekData.stats.rec_td|| 0}</td>
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Rest of Season Projected Total: {player.rosProjTotal.toFixed(2)}
                  </p>
